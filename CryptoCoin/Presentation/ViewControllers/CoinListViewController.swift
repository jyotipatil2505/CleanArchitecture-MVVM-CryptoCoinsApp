    ...
    private func showNoDataView() {
        if noDataView == nil {
            ...
            NSLayoutConstraint.activate([
                ...
                newNoDataView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
                newNoDataView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
            ])
